...
export class CrimslimeMinion extends ModProjectile {
    constructor() {
        super();
        this.Texture = 'Projectiles/Summon/CrimslimeMinion';
        this.AIType = 266;
        this.BuffType = 0;
        this.BabyBuffType = 0;
    }
    ...
    PostSetupContent() {
        this.BuffType = Number(ModBuff.getTypeByName('Crimslime') || 0);
