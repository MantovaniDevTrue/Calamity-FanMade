...
export class SlimeGodRelicGlobalTile extends GlobalTile {
    GetSystem() {
        return ModSystem.getByName('SlimeGodRelicSystem');
    }
    ...
    OnPlace(player, i, j, type, style) {
        ...
        if (!system)
            return;
        const customType = Number(ModItem.getTypeByName('SlimeGodRelic') || 0);
