...
export class SlimeGodTrophyGlobalTile extends GlobalTile {
    GetSystem() {
        return ModSystem.getByName('SlimeGodTrophySystem');
    }
    ...
    OnPlace(player, i, j, type, style) {
        ...
        if (!system)
            return;
        const customType = Number(ModItem.getTypeByName('SlimeGodTrophy') || 0);
