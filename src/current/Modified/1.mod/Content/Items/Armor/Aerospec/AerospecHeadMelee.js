...
export class AerospecHeadMelee extends ModItem {
    constructor() { super(); this.Texture = 'Items/Armor/Aerospec/AerospecHeadMelee'; this.ResearchUnlockCount = 1; }
    SetDefaults() {
    ...
    UpdateArmorSet(item, player) {
        player.setBonus = ModLocalization.getTranslationArmorSetBonus('AerospecMelee');
        ApplyAerospecSet(player, 'melee');
    }
