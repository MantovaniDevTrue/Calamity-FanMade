...
export class VictideHeadRogue extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Armor/Victide/VictideHeadRogue';
    ...
    UpdateEquip(item, player) {
        AddVictideClassDamage(player, 'rogue', 0.05);
    }

    UpdateArmorSet(item, player) {
        player.setBonus = ModLocalization.getTranslationArmorSetBonus('VictideRogue');
        ApplyVictideArmorSet(player, item, 'rogue');
    }
