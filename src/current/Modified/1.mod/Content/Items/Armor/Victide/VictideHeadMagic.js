...
export class VictideHeadMagic extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Armor/Victide/VictideHeadMagic';
    ...
    UpdateEquip(item, player) {
        AddVictideClassDamage(player, 'magic', 0.05);
    }

    UpdateArmorSet(item, player) {
        player.setBonus = ModLocalization.getTranslationArmorSetBonus('VictideMagic');
        ApplyVictideArmorSet(player, item, 'magic');
    }
