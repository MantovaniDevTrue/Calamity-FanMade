...
export class RotBall extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        i.shoot = ModProjectile.getTypeByName('RotBallProjectile');
        i.shootSpeed = 16;
    ...
    Shoot(item, player, pos, vel, type, damage, kb) {
        ...
        SpawnMarkedProjectile(player, item, pos, vel, type, damage * (stealth ? StealthDamageMultiplier(player, 'RotBall') : 1), kb, 'RotBall', stealth, false, 0, 0, 0);
        return false;
    }
}
