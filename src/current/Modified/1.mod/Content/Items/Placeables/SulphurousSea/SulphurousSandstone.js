...
export class SulphurousSandstone extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/SulphurousSea/SulphurousSandstone';
        this.ResearchUnlockCount = 100;
    }

    SetDefaults() {
        this.DefaultToPlaceableTile(SulphurousSeaAnchorTiles.sandstone, 0);
    ...
    CanUseItem(item, player) {
        SulphurousSeaMaterialRuntime.MarkPending(player, SulphurousSeaMaterialKinds.Sandstone);
        return true;
    }
}
