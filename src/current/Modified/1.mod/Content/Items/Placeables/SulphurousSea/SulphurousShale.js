...
export class SulphurousShale extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/SulphurousSea/SulphurousShale';
        this.ResearchUnlockCount = 100;
    }

    SetDefaults() {
        this.DefaultToPlaceableTile(SulphurousSeaAnchorTiles.shale, 0);
    ...
    CanUseItem(item, player) {
        SulphurousSeaMaterialRuntime.MarkPending(player, SulphurousSeaMaterialKinds.Shale);
        return true;
    }
}
