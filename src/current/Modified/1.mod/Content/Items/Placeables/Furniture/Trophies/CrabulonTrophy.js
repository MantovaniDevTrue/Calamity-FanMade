...
export class CrabulonTrophy extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/Trophies/CrabulonTrophy';
    ...
    CanUseItem(item, player) {
        const system = ModSystem.getByName('CrabulonTrophySystem');
        if (system)
