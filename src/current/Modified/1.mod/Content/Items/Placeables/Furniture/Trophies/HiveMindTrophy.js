...
export class HiveMindTrophy extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/Trophies/HiveMindTrophy';
    ...
    CanUseItem(item, player) {
        const system = ModSystem.getByName('HiveMindTrophySystem');
        if (system)
