...
export class HiveMindRelic extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/BossRelics/HiveMindRelic';
    ...
    CanUseItem(item, player) {
        const system = ModSystem.getByName('HiveMindRelicSystem');
        if (system)
