...
export class GiantClamTrophy extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/Trophies/GiantClamTrophy';
    ...
    CanUseItem(item, player) {
        const s = ModSystem.getByName('GiantClamTrophySystem');
        if (s)
