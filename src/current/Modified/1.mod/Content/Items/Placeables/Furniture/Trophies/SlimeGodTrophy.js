...
export class SlimeGodTrophy extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/Trophies/SlimeGodTrophy';
    ...
    CanUseItem(item, player) {
        const s = ModSystem.getByName('SlimeGodTrophySystem');
        if (s)
