...
export class GiantClamRelic extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/BossRelics/GiantClamRelic';
    ...
    CanUseItem(item, player) {
        const s = ModSystem.getByName('GiantClamRelicSystem');
        if (s)
