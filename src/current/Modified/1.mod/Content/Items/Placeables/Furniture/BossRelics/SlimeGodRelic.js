...
export class SlimeGodRelic extends ModItem {
    constructor() {
        super();
        this.Texture = 'Items/Placeables/Furniture/BossRelics/SlimeGodRelic';
    ...
    CanUseItem(item, player) {
        const s = ModSystem.getByName('SlimeGodRelicSystem');
        if (s)
