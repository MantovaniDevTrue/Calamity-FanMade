...
export class EffigyOfDecay extends ModItem {
    constructor() { super(); this.Texture = 'Items/Placeables/Furniture/EffigyOfDecay'; this.ResearchUnlockCount = 1; }
    SetDefaults() {
        const i = this.Item;
        i.width = 26; i.height = 32;
