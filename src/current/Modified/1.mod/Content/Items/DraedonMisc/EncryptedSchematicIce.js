...
const KEY='calamity:draedon:iceSchematicFound';
export class EncryptedSchematicIce extends ModItem{
 constructor(){super();this.Texture='Items/DraedonMisc/EncryptedSchematicIce';}
